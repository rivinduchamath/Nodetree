...
public class NodeController {
    ...
    @RequestMapping(value = "/childs/{id}", method = GET, produces = "application/json")
    @ResponseBody
    ...
    @Transactional
    @RequestMapping(value = "/update/{nodeId}/parent/{parentId}", method = PUT, produces = "application/json")
    @ResponseBody
